...
#endif
            Controls.Add(_synthButton = new NavigationButton(new Vector2(viewSafeArea.Left + 100, viewSafeArea.Y + viewSafeArea.Bottom - buttonHeight), Strings.ButtonSynth, new NavigationEventArgs(Main.Pages.Synth)));
            Controls.Add(_bassButton = new NavigationButton(new Vector2(viewSafeArea.Left + 200, viewSafeArea.Y + viewSafeArea.Bottom - buttonHeight), Strings.ButtonBass, new NavigationEventArgs(Main.Pages.Bass)));
            Controls.Add(_drumsButton = new NavigationButton(new Vector2(viewSafeArea.Left, viewSafeArea.Y + viewSafeArea.Bottom - buttonHeight), Strings.ButtonDrums, new NavigationEventArgs(Main.Pages.Drums)));
            Controls.Add(_clearButton = new NavigationButton(new Vector2(viewSafeArea.Left + viewSafeArea.Width - 100, viewSafeArea.Y + viewSafeArea.Bottom - buttonHeight), Strings.ButtonClear, null));
